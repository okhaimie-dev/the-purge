    ...
    return (
        <div className="w-full min-h-screen bg-black flex flex-col items-center justify-center">
            <div className="flex flex-col items-center justify-center space-y-5 w-full h-full">
                <Header />
                <div className="w-[768px] h-full max-h-[85vh] overflow-y-scroll absolute top-14 bg-gradient-to-br from-white via-transparent to-white rounded-xl p-0.5 hide-scrollbar">
